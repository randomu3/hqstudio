...
* **desktop:** исправлено наложение лоадера и пустого состояния ([1f410e7](https://github.com/randomu3/hqstudio/commit/1f410e7))
...
* **desktop:** мягкое удаление для заказов ([17eb26e](https://github.com/randomu3/hqstudio/commit/17eb26e0d72568a69e9e83ffad8290533e2a6c93))
